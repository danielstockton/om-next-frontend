...
return cljs.core.assoc.call(null,frame,new cljs.core.Keyword(null,"eids","eids",1546550700),eids,new cljs.core.Keyword(null,"specs","specs",1426570741),cljs.core.seq.call(null,new cljs.core.Keyword(null,"attrs","attrs",-2090668713).cljs$core$IFn$_invoke$arity$1(pattern)),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101),new cljs.core.Keyword(null,"wildcard?","wildcard?",-686044101).cljs$core$IFn$_invoke$arity$1(pattern),new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.transient$.call(null,cljs.core.PersistentArrayMap.EMPTY),new cljs.core.Keyword(null,"results","results",-1134170113),(function (){var G__22905 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__22905,kvps);
} else {
return G__22905;
}
})());
...
var depth = cljs.core.get.call(null,map__22908__$1,new cljs.core.Keyword(null,"depth","depth",1768663640));
var seen = cljs.core.get.call(null,map__22908__$1,new cljs.core.Keyword(null,"seen","seen",-518999789));
...
var G__22911 = new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame);
var G__22911__$1 = (((G__22911 == null))?null:cljs.core.persistent_BANG_.call(null,G__22911));
if((G__22911__$1 == null)){
return null;
} else {
return cljs.core.get.call(null,G__22911__$1,key);
}
});
...
datascript.pull_api.pull_recursion_frame = (function datascript$pull_api$pull_recursion_frame(db,p__22912){
var vec__22915 = p__22912;
var frame = cljs.core.nth.call(null,vec__22915,(0),null);
var frames = cljs.core.nthnext.call(null,vec__22915,(1));
...
var or__18383__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame__$1,frames,eid);
...
var results = (function (){var G__22916 = new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(frame);
if(cljs.core.seq.call(null,kvps)){
return cljs.core.conj_BANG_.call(null,G__22916,kvps);
} else {
return G__22916;
}
})();
...
var recursion = cljs.core.get.call(null,map__22919__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var pattern = cljs.core.get.call(null,map__22919__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
...
var pattern_22921 = (new datascript.pull_parser.PullSpec(true,cljs.core.PersistentArrayMap.EMPTY,null,null,null));
datascript.pull_api.expand_frame = ((function (pattern_22921){
...
return cljs.core.assoc.call(null,datascript.pull_api.subpattern_frame.call(null,pattern_22921,eids,multi_QMARK_,attr_key),new cljs.core.Keyword(null,"recursion","recursion",-749738765),rec);
});})(pattern_22921))
;
datascript.pull_api.pull_attr_datoms = (function datascript$pull_api$pull_attr_datoms(db,attr_key,attr,eid,forward_QMARK_,datoms,opts,p__22923){
var vec__22929 = p__22923;
var parent = cljs.core.nth.call(null,vec__22929,(0),null);
var frames = cljs.core.nthnext.call(null,vec__22929,(1));
...
var found = cljs.core.not_empty.call(null,(function (){var G__22930 = datoms;
if(cljs.core.truth_(limit)){
return cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.take.call(null,limit),G__22930);
} else {
return G__22930;
}
})());
...
var datom_val = (cljs.core.truth_(forward_QMARK_)?((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__22929,parent,frames){
return (function (d){
return d.v;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__22929,parent,frames))
:((function (ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__22929,parent,frames){
return (function (d){
return d.e;
});})(ref_QMARK_,component_QMARK_,multi_QMARK_,limit,found,vec__22929,parent,frames))
);
...
if(cljs.core.truth_((function (){var and__18371__auto__ = component_QMARK_;
...
var as_value = (function (){var G__22931 = datom_val;
if(ref_QMARK_){
return cljs.core.comp.call(null,((function (G__22931,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__22929,parent,frames){
return (function (p1__22922_SHARP_){
return cljs.core.PersistentHashMap.fromArrays([new cljs.core.Keyword("db","id","db/id",-1388397098)],[p1__22922_SHARP_]);
});})(G__22931,ref_QMARK_,component_QMARK_,multi_QMARK_,datom_val,limit,found,vec__22929,parent,frames))
,G__22931);
} else {
return G__22931;
}
...
return cljs.core.conj.call(null,frames,cljs.core.update.call(null,parent,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,(function (){var G__22932 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,as_value),found);
if(single_QMARK_){
return cljs.core.first.call(null,G__22932);
} else {
return G__22932;
}
})()));
...
return cljs.core.conj.call(null,frames,(function (){var G__22933 = parent;
if(cljs.core.contains_QMARK_.call(null,opts,new cljs.core.Keyword(null,"default","default",-1987822328))){
return cljs.core.update.call(null,G__22933,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,attr_key,new cljs.core.Keyword(null,"default","default",-1987822328).cljs$core$IFn$_invoke$arity$1(opts));
} else {
return G__22933;
}
})());
...
var vec__22935 = spec;
var attr_key = cljs.core.nth.call(null,vec__22935,(0),null);
var opts = cljs.core.nth.call(null,vec__22935,(1),null);
...
datascript.pull_api.filter_reverse_attrs = cljs.core.filter.call(null,(function (p__22936){
var vec__22937 = p__22936;
var k = cljs.core.nth.call(null,vec__22937,(0),null);
var v = cljs.core.nth.call(null,vec__22937,(1),null);
...
datascript.pull_api.pull_expand_frame = (function datascript$pull_api$pull_expand_frame(db,p__22941){
var vec__22944 = p__22941;
var frame = cljs.core.nth.call(null,vec__22944,(0),null);
var frames = cljs.core.nthnext.call(null,vec__22944,(1));
...
var vec__22945 = cljs.core.first.call(null,datoms_by_attr);
var attr = cljs.core.nth.call(null,vec__22945,(0),null);
var datoms = cljs.core.nth.call(null,vec__22945,(1),null);
...
var attr = cljs.core.get.call(null,map__22949__$1,new cljs.core.Keyword(null,"attr","attr",-604132353));
var recursion = cljs.core.get.call(null,map__22949__$1,new cljs.core.Keyword(null,"recursion","recursion",-749738765));
var rec = (function (){var G__22951 = recursion;
if(cljs.core.some_QMARK_.call(null,attr)){
return datascript.pull_api.push_recursion.call(null,G__22951,attr,eid);
} else {
return G__22951;
}
})();
...
var eid = cljs.core.get.call(null,map__22954__$1,new cljs.core.Keyword(null,"eid","eid",559519930));
var pattern = cljs.core.get.call(null,map__22954__$1,new cljs.core.Keyword(null,"pattern","pattern",242135423));
var or__18383__auto__ = datascript.pull_api.pull_seen_eid.call(null,frame,frames,eid);
if(cljs.core.truth_(or__18383__auto__)){
return or__18383__auto__;
} else {
...
datascript.pull_api.pull_pattern_frame = (function datascript$pull_api$pull_pattern_frame(db,p__22956){
while(true){
var vec__22958 = p__22956;
var frame = cljs.core.nth.call(null,vec__22958,(0),null);
var frames = cljs.core.nthnext.call(null,vec__22958,(1));
var temp__4655__auto__ = cljs.core.seq.call(null,new cljs.core.Keyword(null,"eids","eids",1546550700).cljs$core$IFn$_invoke$arity$1(frame));
if(temp__4655__auto__){
var eids = temp__4655__auto__;
...
var G__22959 = db;
var G__22960 = cljs.core.conj.call(null,frames,datascript.pull_api.reset_frame.call(null,frame,cljs.core.rest.call(null,eids),cljs.core.not_empty.call(null,cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"kvps","kvps",65308317).cljs$core$IFn$_invoke$arity$1(frame)))));
db = G__22959;
p__22956 = G__22960;
continue;
}
...
while(true){
var G__22965 = (((new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)) instanceof cljs.core.Keyword))?new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.first.call(null,frames)).fqn:null);
switch (G__22965) {
case "expand":
var G__22970 = db;
var G__22971 = datascript.pull_api.pull_expand_frame.call(null,db,frames);
db = G__22970;
frames = G__22971;
continue;
...
case "expand-rev":
var G__22972 = db;
var G__22973 = datascript.pull_api.pull_expand_reverse_frame.call(null,db,frames);
db = G__22972;
frames = G__22973;
continue;
...
case "pattern":
var G__22974 = db;
var G__22975 = datascript.pull_api.pull_pattern_frame.call(null,db,frames);
db = G__22974;
frames = G__22975;
continue;
...
case "recursion":
var G__22976 = db;
var G__22977 = datascript.pull_api.pull_recursion_frame.call(null,db,frames);
db = G__22976;
frames = G__22977;
continue;
...
break;
case "done":
var vec__22966 = frames;
var f = cljs.core.nth.call(null,vec__22966,(0),null);
var remaining = cljs.core.nthnext.call(null,vec__22966,(1));
var result = (function (){var G__22967 = cljs.core.persistent_BANG_.call(null,new cljs.core.Keyword(null,"results","results",-1134170113).cljs$core$IFn$_invoke$arity$1(f));
if(cljs.core.not.call(null,new cljs.core.Keyword(null,"multi?","multi?",-749311069).cljs$core$IFn$_invoke$arity$1(f))){
return cljs.core.first.call(null,G__22967);
} else {
return G__22967;
}
})();
...
var G__22978 = db;
var G__22979 = cljs.core.conj.call(null,cljs.core.rest.call(null,remaining),(function (){var G__22968 = cljs.core.first.call(null,remaining);
if(cljs.core.truth_(result)){
return cljs.core.update.call(null,G__22968,new cljs.core.Keyword(null,"kvps","kvps",65308317),cljs.core.assoc_BANG_,new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(f),result);
} else {
return G__22968;
}
})());
...
var eids__$1 = cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.map.call(null,(function (p1__22980_SHARP_){
return datascript.db.entid_strict.call(null,db,p1__22980_SHARP_);
})),eids);
