...
document.write('<script>if (typeof goog != "undefined") { goog.require("om_next_frontend.core"); } else { console.warn("ClojureScript could not load :main, did you forget to specify :asset-path?"); };</script>');