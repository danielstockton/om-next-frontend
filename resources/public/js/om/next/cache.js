...
var self__ = this;
var this$ = this;
var x_SINGLEQUOTE__19499 = cljs.core.vary_meta.call(null,x,cljs.core.assoc,new cljs.core.Keyword(null,"client-time","client-time",-1212214195),(new Date()));
if((self__.size <= self__.arr.length)){
var id_SINGLEQUOTE__19500 = self__.arr.shift();
cljs.core.swap_BANG_.call(null,self__.index,((function (id_SINGLEQUOTE__19500,x_SINGLEQUOTE__19499,this$){
return (function (p1__19498_SHARP_){
return cljs.core.assoc.call(null,cljs.core.dissoc.call(null,p1__19498_SHARP_,id_SINGLEQUOTE__19500),id,x_SINGLEQUOTE__19499);
});})(id_SINGLEQUOTE__19500,x_SINGLEQUOTE__19499,this$))
);
} else {
cljs.core.swap_BANG_.call(null,self__.index,cljs.core.assoc,id,x_SINGLEQUOTE__19499);
}
...
om.next.cache.Cache.cljs$lang$ctorPrWriter = (function (this__18982__auto__,writer__18983__auto__,opt__18984__auto__){
return cljs.core._write.call(null,writer__18983__auto__,"om.next.cache/Cache");
});
